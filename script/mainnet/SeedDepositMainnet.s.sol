...
/// @notice Broadcast by the VM (it holds the USDC). Approves the AaveRouter, deposits USDC (→ aUSDC →
...
contract SeedDepositMainnet is Script {
    ...
    address constant AAVE_ROUTER = 0x5744daea555ebbE2d8e093fF8b79eD7513bb20DF;
    ...
    function run() external {
        ...
        IERC20(USDC).approve(AAVE_ROUTER, AMOUNT);
        uint256 shares = IAaveRouter(AAVE_ROUTER).deposit(USDC, IERC4626(VAULT), AMOUNT, vmAddr, 0);
